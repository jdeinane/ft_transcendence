...
urlpatterns = [
	...
	path("tournaments/create/", create_tournament, name="create-tournament"),
	path("tournaments/<int:tournament_id>/join/", join_tournament, name="join-tournament"),
	path("tournaments/<int:tournament_id>/leave/", leave_tournament, name="leave-tournament"),
	path("tournaments/", list_tournaments, name="list-tournaments"),
	path("api/tournaments/", list_tournaments, name="list-tournaments"),
	path("tournaments/<int:tournament_id>/", get_tournament_details, name="tournament-details"),
	path("tournaments/<int:tournament_id>/matches/", list_tournament_matches, name="list-matches"),
	path("tournaments/match/result/", submit_match_result, name="submit-match-result"),
	path("tournaments/<int:tournament_id>/winner/", get_tournament_winner, name="tournament-winner"),
]
